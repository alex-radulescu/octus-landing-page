...
gulp.task('build', ['clean', 'set-production', 'scripts', 'css', 'set-development']); // PRODUCTION
gulp.task('default', ['clean', 'scripts', 'css', 'watch-scripts', 'watch-css', 'browser-sync']); // DEVELOPMENT
